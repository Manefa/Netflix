                ...
                <div id="grid-movies">
                    ...
                    <div class="card carousel-cell">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 text-center no-padding">
                                    <a href="">
                                        <img src="media/icons/eye.png" width="10" alt="Views">
                                    </a>
                                </div>
                                <div class="col-3 text-left no-padding">
                                    <a href="">
                                        <img src="media/icons/heart.png" width="10" alt="Favorite">
                                    </a>
                                </div>
                                <div class="col-3 text-right no-padding rating">
                                    <img src="media/icons/star.png" width="10" alt=""
                            ...
                            <div class="overlay">
                                <div class="text">
                                    <a href="{{ route('films.show', [$film]) }}" class="btn btn-secondary btn-sm margin-top-under-sm"
