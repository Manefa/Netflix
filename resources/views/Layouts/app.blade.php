...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark" id="navbar">
        ...
        <a href="https://github.com/eduayme/netflix" class="github-corner" aria-label="View source on GitHub"><svg width="55" height="55" viewBox="0 0 250 250" style="fill: #fff; color: #141414; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
